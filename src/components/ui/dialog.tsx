...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid max-h-[90vh] w-full overflow-y-auto",
        "translate-x-[-50%] translate-y-[-50%] gap-4 border border-slate-200",
        "cursor-default bg-pearl p-6 shadow-lg duration-200",
        ...
        "max-w-xs sm:max-w-xl md:max-w-2xl", // Increased max-width at different breakpoints
        className
      )}
      {...props}
    >
