    ...
    <div className="w-full max-w-4xl space-y-4">
      ...
      <div className="rounded-md border">
        <ScrollArea className="h-[400px]">
          <Table>
            <TableHeader className="bg-pearlVariant3 sticky top-0 font-dm_sans font-black text-midnight">
              {table.getHeaderGroups().map((headerGroup) => (
                <TableRow key={headerGroup.id}>
                  {headerGroup.headers.map((header) => (
                    <TableHead
                      key={header.id}
                      className="font-dm_sans text-base font-semibold text-midnight"
                    >
            ...
            <TableBody className="text-tableContent bg-pearlVariant text-sm">
