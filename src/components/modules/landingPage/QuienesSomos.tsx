"use client"
import { Cuerpo, Bienestar, Espiritu, Mente } from "@/assets/icons"
...
export default function QuienesSomos() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex h-auto scroll-mt-28 items-center justify-center p-16 py-20 lg:basis-[60%] lg:py-28"
      ...
      >
        <div className="flex max-w-lg flex-col items-start gap-10 text-justify font-dm_sans">
          ...
          <div className="grid h-auto w-full grid-cols-2 gap-8 sm:flex sm:items-center sm:justify-between">
            ...
            >
              <Cuerpo className="h-3/5 text-grey_pebble" />
            ...
            <motion.div
              ...
              className="flex h-32 flex-col items-center justify-center gap-4"
            >
              <Mente className="h-3/5 text-grey_pebble" />
            ...
            <motion.div
              ...
              className="flex h-32 flex-col items-center justify-center gap-4"
            >
              <Espiritu className="h-3/5 text-grey_pebble" />
            ...
            <motion.div
              ...
              className="flex h-32 flex-col items-center justify-center gap-4"
            >
              <Bienestar className="h-3/5 text-grey_pebble" />
